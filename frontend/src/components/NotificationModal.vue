  ...
  >
    ...
    >
      ...
      <div
        ...
        class="flex items-start justify-between p-4 md:p-6 border-b border-slate-200 dark:border-slate-700 rounded-t-2xl"
      >
        ...
        <button
          type="button"
          class="absolute top-3 right-3 text-slate-400 bg-transparent hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
          @click="hide"
        >
      ...
      <div class="p-4 md:p-6">
        <div
          v-if="showWarningsList"
          id="notification-modal-warnings-list"
          class="space-y-3"
        >
          <div
            v-for="(warning, index) in warnings"
            :key="index"
            class="flex items-start gap-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-800"
          >
            <div>
              ...
              <a
                v-if="warning.call_to_action_link"
                :href="warning.call_to_action_link"
        ...
        <p
          v-else
          class="text-sm font-normal text-slate-600 dark:text-slate-300"
          v-html="message"
        />
      </div>
      ...
      <!-- Modal Footer -->
      <div
        id="notification-modal-footer"
        class="flex items-center justify-end space-x-3 p-4 md:p-6 border-t border-slate-200 dark:border-slate-700 rounded-b-2xl"
      >
