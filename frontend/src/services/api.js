...
const buildPublicSetupEndpoints = (request, apiRequest) => ({
...
const buildFinanceDataEndpoints = (request) => ({
...
const buildNocodbResourcesEndpoints = (request) => ({
...
const buildBudgetsEndpoints = (request) => ({
...
const buildCategoriesItemsEndpoints = (request) => ({
...
const buildInstallmentsEndpoints = (request) => ({
...
const buildCashFlowEndpoints = (request) => ({
...
const buildTransactionsEndpoints = (request) => ({
...
const buildSubscriptionsEndpoints = (request) => ({
...
const buildSettingsEndpoints = (request) => ({
...
const buildTaggingRulesEndpoints = (request) => ({
...
const buildSavingsGoalsEndpoints = (request) => ({
...
export const api = (getToken) => {
    ...
    return {
        ...
        ...buildCategoriesItemsEndpoints(request),
        ...buildInstallmentsEndpoints(request),
        ...buildCashFlowEndpoints(request),
        ...buildTransactionsEndpoints(request),
        ...buildSubscriptionsEndpoints(request),
        ...buildSettingsEndpoints(request),
        ...buildTaggingRulesEndpoints(request),
        ...buildSavingsGoalsEndpoints(request),
        ...buildAnomaliesEndpoints(request)
    };
};
